...
from android_world.agents import genesis_agents
...
def _get_agent(
  ...
  # elif _AGENT_NAME.value == 't3a_gpt4':
  #   agent = t3a.T3A(env, infer.Gpt4Wrapper('gpt-4-turbo-2024-04-09'))
  elif _AGENT_NAME.value == 'genesis_agent':
    agent = genesis_agents.M3A(env, infer.Gpt4Wrapper('gpt-4-turbo-2024-04-09'))
  # SeeAct.
